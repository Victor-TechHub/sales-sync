        ...
        <header className="flex flex-col gap-7">
            <section className="flex justify-between items-center">
                <div>
                    ...
                    <p>You have 2 <span className="text-blue-500">unread</span> notifications</p>
                </div>

                <div className="flex items-center gap-2">
                    <div className="shadow-lg relative border border-stone-100 rounded-full p-2">
                        <GoBell size={19} />
            ...
            <section className="flex md:flex-row flex-col justify-between gap-4 md:gap-0 md:items-center">
                <div className="flex bg-stone-100 md:w-[50%] items-center px-2 w-full rounded-md">
                    <CiSearch size={20} />
                    <input type="text" placeholder="Search..." className="bg-transparent px-2 py-3 outline-none flex-1" />
                    <div className="flex items-center gap-1">
                        <span className="bg-[#FFF] grid place-content-center rounded-md h-7 w-7">
                            <MdOutlineKeyboardCommandKey size={18} />
                        </span>
                        <span className="bg-[#FFF] grid place-content-center rounded-md text-sm h-7 w-7">K</span>
                    </div>
                </div>
